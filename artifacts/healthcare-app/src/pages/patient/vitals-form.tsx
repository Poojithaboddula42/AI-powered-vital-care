...
export default function RecordVitals() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Record Vitals</h1>
        <p className="text-muted-foreground mt-1">Enter your current health measurements.</p>
      </div>
