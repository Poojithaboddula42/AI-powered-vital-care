export default function AdminHospitals() {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 h-[80vh]">
      <h1 className="text-3xl font-bold tracking-tight text-foreground mb-1">Hospital Management</h1>
      <p className="text-muted-foreground mb-8">Manage facilities, beds, and resources.</p>
